...
gen_loss0 = fun(x_binary,b_sample1,b_sample2,prior_logit0,reuse_encoder=True,reuse_decoder= False)
...
training_epochs = 3000  #600epoch 42min
...
EXPERIMENT = 'layer2_OMNI_Bernoulli_ARM'
